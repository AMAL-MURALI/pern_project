import { PaletteIcon, PanelLeftIcon } from 'lucide-react'
...
const ThemeSelector = () => {
  ...
  return (
    <div className='dropdown dropdown-end'>
        ...
        <div tabIndex={0} className='dropdown-content mt-1 p-1 shadow-2xl bg-base-200 backdrop-blur-lg rounded-2xl w-56 border-base-content/10 '>
